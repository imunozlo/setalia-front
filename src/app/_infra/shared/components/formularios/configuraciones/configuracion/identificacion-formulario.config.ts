...
import { IdentificacionForm } from '../../../../../../identificacion/forms/identificacion.form';


export const IdentificacionFormularioConfig: FormularioInterface = {
  formulario: IdentificacionForm,
  alertasSpan: 16,
  alertasOffset: 8,
  campos: [
    {
